...
const guideGroups = [
  {
    ...
    slugs: ["body-metrics-calorie-planning-tools", "how-to-calculate-bmi-metric-imperial", "metric-vs-imperial-bmi-formula", "mifflin-st-jeor-examples-men-women", "mifflin-st-jeor-equation-explained", "mifflin-bmr-tdee-maintenance-calories", "metabolic-rate-calculator-vs-bmr", "tdee-activity-multiplier-explained", "maintenance-calories-vs-calorie-deficit-which-number", "bmr-vs-resting-calorie-calculator", "maintenance-calories-vs-calorie-deficit", "bmi-vs-body-fat-vs-waist", "bmr-vs-tdee-vs-calorie-goal", "bmr-vs-rmr-vs-tdee", "how-to-set-macro-targets", "protein-per-meal-vs-daily-protein"]
  },
  {
    title: "Sleep & Daily Movement",
    description: "Separate sleep timing, sleep quality, sleep debt, and practical movement goals.",
    slugs: ["sleep-schedule-and-sleep-quality", "sleep-debt-vs-sleep-quality", "how-to-choose-a-realistic-daily-step-goal", "common-walking-distances-to-steps", "desk-breaks-walking-and-focus-planning"]
  },
  {
