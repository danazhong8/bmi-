...
function renderHome() {
  ...
  const featuredGuides = featuredGuideSlugs
    ...
    .filter(Boolean)
    .map((guide) => `<a class="home-guide" href="guides/${guide.slug}.html" data-guide-slug="${guide.slug}"><span class="guide-visual" aria-hidden="true"></span><small>${esc(guide.primaryQuery)}</small><strong>${esc(guide.h1)}</strong><span>${esc(guide.description)}</span><em>Read guide &rarr;</em></a>`)
    .join("");
