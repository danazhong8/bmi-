...
function renderHome() {
  ...
  const trustProof = `<section class="trust-proof" aria-label="Method and privacy proof"><div class="trust-proof-item"><strong>Method before result</strong><span>Calculator pages show formulas, assumptions, examples, and limits so the number is easier to inspect.</span></div><div class="trust-proof-item"><strong>Private by default</strong><span>Core calculator inputs and self-check answers run in the browser and are not required for an account.</span></div><div class="trust-proof-item"><strong>Educational boundaries</strong><span>Self-checks state that they are original reflection tools, not diagnostic instruments.</span></div><div class="trust-proof-item"><strong>Search-informed upkeep</strong><span>Homepage paths and tool snippets are adjusted from Search Console visibility and click data.</span></div></section>`;
